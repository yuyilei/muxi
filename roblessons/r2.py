...
def choose_loop():
    ...
    while True:
        time.sleep(1)
        try :
            browser.find_element_by_xpath('//*[@id="tr_6141B5313F096F76E0531E50A8C00691"]/td[21]/button').click()
        except :
            pass
        try:
            #如果没有叉号则选课成功了
            browser.find_element_by_xpath('//*[@id="alertModal"]/div/div/div[1]/button/span[1]').click()
            time.sleep(1)
        except:
            pass
